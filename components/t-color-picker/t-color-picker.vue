		...
		<view class="t-box" :class="{active:active}">
			...
			<view class="t-control__box">
				...
				<view class="t-control-box__item">
					...
					<view class="t-controller boxs" @touchstart="touchstart($event, 2)" @touchmove="touchmove($event, 2)" @touchend="touchend($event, 2)" v-if="showOpcity">
	...
	export default {
		...
		methods: {
			...
			changeViewByHsb() {
				...
				this.showOpcity && (this.site[2].left = this.rgba.a * c.width);
			},
			/**
			 * hsb 转 rgb
